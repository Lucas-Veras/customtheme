...
<section>
    ...
    <div class="programacao-box">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-teste-tab" data-bs-toggle="pill" data-bs-target="#pills-teste" type="button" role="tab" aria-controls="pills-teste" aria-selected="false">Contact</button>
            </li>
        </ul>
    </div>
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade" id="pills-teste" role="tabpanel" aria-labelledby="pills-teste-tab" tabindex="0">
            4.aaaaaaaaaaaaa..
        </div>
    </div>
  </div>
